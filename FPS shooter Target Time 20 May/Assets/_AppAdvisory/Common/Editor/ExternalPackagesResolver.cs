...
namespace AppAdvisory
{
	public class ExternalPackagesResolver  
	{
		...
		public static readonly string AudienceNetwork = "Assets/AudienceNetwork";

		public static readonly string FacebookFolder = "Assets/Facebook";
		public static readonly string TwitterFolder = "Assets/Fabric/Kits/Twitter";
		...
		private static readonly string AudienceNetworkNamespaceName = "Assets/AudienceNetwork";
		...
		public static bool IsFacebookAvailable {
			get 
			{
				return Directory.Exists (AudienceNetwork);
			}
		}
		...
		public static bool IsFacebookNamespaceAvailable {
			get 
			{
				return ReflectionUtils.NamespaceExists (AudienceNetworkNamespaceName);
			}
