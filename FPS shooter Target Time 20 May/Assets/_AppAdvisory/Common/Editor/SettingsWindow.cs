			...
			*/
			...
			//#if UNITY_ADS
				...
				if(adIDs.IsUnityAdsSettingsOpened)
				{
					...
					EditorWindowUtils.CreateTextField(ref adIDs.gameIdIOS, "Unity GameID for iOS ", "Find it on https://dashboard.unityads.unity3d.com", margin * 3);
					EditorWindowUtils.CreateTextField(ref adIDs.gameIdAndroid, "Unity GameID for Android ", "Find it on https://dashboard.unityads.unity3d.com", margin * 3);
				}
				EditorWindowUtils.Space(2);
