...
namespace AppAdvisory
{
	public class ScriptingSymbolsManager
	{
		...
		private static readonly string FACEBOOK_SDK_INSTALLED = "FACEBOOK_SDK_INSTALLED";
		private static readonly string TWITTER_SDK_INSTALLED = "TWITTER_SDK_INSTALLED";
		...
		public static void SetAudienceNetworkSymbol(bool isActivate) {
			//SetScriptingSymbolsMobile(FACEBOOK, isActivate);
			SetScriptingSymbolsAll(FACEBOOK, isActivate);
		}

		public static void SetFacebookSDKInstalledSymbol(bool isActivate) {

			SetScriptingSymbolsAll (FACEBOOK_SDK_INSTALLED, isActivate);
		}

		public static void SetTwitterSDKInstalledSymbol(bool isActivate) {

			SetScriptingSymbolsAll (TWITTER_SDK_INSTALLED, isActivate);
		}
